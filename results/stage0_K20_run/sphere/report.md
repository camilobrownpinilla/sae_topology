...
- [x] Stable region size ≥ 50% of grid (got 18/24 = 75%)
- [x] Stable region is contiguous (n_correct_anywhere = 18)
...
- [ ] Eigenvector-basis-rotation reproducibility (spectral-only) for T²/S² (E_diff=0.0001, fail)
...
- GT-filter correct-region: 79% (size=19)
- PCA-filter correct-region: 79% (size=19)
