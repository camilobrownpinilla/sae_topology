# Stage 1 Sign-off — `sphere` / `jumprelu` (m=128, seed=0)
...
- [ ] Correct-region size ≥ 50% of grid (got 10/24 = 42%)
- [x] Correct region is contiguous (n_correct_total = 10)
...
- [ ] Spectral log-ratio error E < 0.05 on post-activations (E=0.0779)
