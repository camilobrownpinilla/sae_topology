...
- [x] Correct-region size ≥ 50% of grid (got 18/24 = 75%)
- [x] Correct region is contiguous (n_correct_total = 18)
...
- [ ] Spectral log-ratio error E < 0.05 on post-activations (E=0.1837)
- [ ] Multiplicity-cluster check passes for first 4 clusters
- [ ] Near-zero eigenvalue count = b₀ (got 3, expected 1)
