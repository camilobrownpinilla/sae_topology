...
- [x] Correct-region size ≥ 50% of grid (got 12/24 = 50%)
- [x] Correct region is contiguous (n_correct_total = 12)
...
- [x] Spectral log-ratio error E < 0.05 on post-activations (E=0.0455)
- [ ] Multiplicity-cluster check passes for first 4 clusters
- [ ] Near-zero eigenvalue count = b₀ (got 6, expected 1)
