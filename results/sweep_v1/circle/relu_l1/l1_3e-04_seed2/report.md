...
- [ ] Correct-region size ≥ 50% of grid (got 9/24 = 38%)
- [x] Correct region is contiguous (n_correct_total = 9)
...
- [ ] Spectral log-ratio error E < 0.05 on post-activations (E=0.1414)
- [ ] Multiplicity-cluster check passes for first 4 clusters
- [ ] Near-zero eigenvalue count = b₀ (got 5, expected 1)
