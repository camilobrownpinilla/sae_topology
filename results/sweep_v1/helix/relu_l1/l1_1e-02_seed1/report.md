# Stage 1 Sign-off — `helix` / `relu_l1` (m=128, seed=1)
...
- [x] Correct-region size ≥ 50% of grid (got 21/24 = 88%)
- [x] Correct region is contiguous (n_correct_total = 21)
...
- [x] Spectral log-ratio error E < 0.05 on post-activations (E=0.0095)
