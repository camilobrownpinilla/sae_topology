...
- [ ] Correct-region size ≥ 50% of grid (got 4/24 = 17%)
- [x] Correct region is contiguous (n_correct_total = 4)
...
- [x] Spectral log-ratio error E < 0.05 on post-activations (E=0.0436)
