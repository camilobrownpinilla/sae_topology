# Stage 1 Sign-off — `torus` / `relu_l1` (m=128, seed=2)
...
- [ ] Correct-region size ≥ 50% of grid (got 5/24 = 21%)
- [x] Correct region is contiguous (n_correct_total = 5)
...
- [x] Spectral log-ratio error E < 0.05 on post-activations (E=0.0430)
