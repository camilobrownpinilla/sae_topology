# Stage 1 Sign-off — `sphere` / `relu_l1` (m=128, seed=0)
...
- [x] Correct-region size ≥ 50% of grid (got 14/24 = 58%)
- [x] Correct region is contiguous (n_correct_total = 14)
...
- [x] Spectral log-ratio error E < 0.05 on post-activations (E=0.0345)
